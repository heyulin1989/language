        ...
        fmt3 db  "Sum of Single Precision Vector 1 and Vector2: "
        db " %f, %f, %f, %f",10,0
...
main:
        ...
        movaps xmm0,[spvector1] ;move aligned packed single precision
        addps xmm1,[spvector2]
...
printspfp:
        ...
        movss xmm0,[rsi]
        cvtss2sd xmm0,xmm0      ;the instruction cvtss2sd (which means “convert scalar single to scalar double”).
        movss xmm1,[rsi+4]
        cvtss2sd xmm1,xmm1
        movss xmm2,[rsi+8]
        cvtss2sd xmm2,xmm2
